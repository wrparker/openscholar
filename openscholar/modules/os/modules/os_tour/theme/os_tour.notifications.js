...
(function ($, w) {
  ...
  w.osTour = {
		  notifications_is_new: notifications_is_new,
		  notifications_item: notifications_item,
		  notifications_fuzzy_date: notifications_fuzzy_date,
		  notifications_count: notifications_count,
		  notifications_read_update: notifications_read_update
  };
  /**
   ...
   * @returns {bool}
   */
  function notifications_is_new(entry) {
   ...
   */
  function notifications_item(entry, num_remaining, count_element) {
   ...
   * @returns {string}
   */
  function notifications_fuzzy_date(time) {
   ...
   */
  function notifications_count(count_element, num_remaining) {
   ...
   */
  function notifications_read_update() {
