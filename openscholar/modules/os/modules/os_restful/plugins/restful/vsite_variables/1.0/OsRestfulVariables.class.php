...
class OsRestfulVariables extends OsRestfulSpaces {
  ...
  private function whiteList() {
    $white_list = array(
      'biblio_%', 'citation_distribute_%', 'comment_%', 'cp_admin_menu',
      'cp_clear_cache', 'cp_redirect_max', 'disqus_domain', 'disqus_nodetypes',
      'enable_responsive', 'field_meta_description', 'flavors',
