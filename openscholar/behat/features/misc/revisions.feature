Feature: Revisions functionality testing.
  ...
  Scenario: View revisions of a blog
    Given I am logging in as a user who "can" "edit own blog entry content"
    ...
    Then I should see "2" revisions for "My New Revised Blog Post"

  @misc_second @api @revisions
  Scenario: View revisions of a book
    Given I am logging in as a user who "can" "edit own book page content"
    ...
    Then I should see "2" revisions for "My New Revised Book Page"

  @misc_second @api @revisions
  Scenario: View revisions of a faq
    Given I am logging in as a user who "can" "edit own faq content"
    ...
    Then I should see "2" revisions for "My New Revised FAQ"

  @misc_second @api @revisions
  Scenario: View revisions of a link
    Given I am logging in as a user who "can" "edit own link content"
    ...
    Then I should see "2" revisions for "My New Revised Link"

  @misc_second @api @revisions
  Scenario: View revisions of a news item
    Given I am logging in as a user who "can" "edit own news content"
    ...
    Then I should see "2" revisions for "My New Revised News"
  ...
  @misc_second @api @revisions
  Scenario: View revisions of a profile
    Given I am logging in as a user who "can" "edit own person content"
     ...
     Then I should see "2" revisions for "Person Test Revised"

  @misc_second @api @revisions
  Scenario: View revisions of a publication
    Given I am logging in as a user who "can" "edit own publication content"
    ...
    Then I should see "2" revisions for "My New Revised Publication"
